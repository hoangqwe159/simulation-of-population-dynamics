...
legend('X1 \rightarrow 0 + tol','X2 \rightarrow 2 ± tol','X1 \rightarrow 0 + tol and X2 \rightarrow 2 ± tol', 'k_5 = -0.78k_4 + 3.89', 'k_5 = 0.003k_4^2 - 0.25k_4 + 16')
hold off
...
legend('X1 \rightarrow 0 + tol','X2 \rightarrow 2 ± tol', 'k_5 = -0.78k_4 + 3.89', 'k_5 = 0.003k_4^2 - 0.25k_4 + 16')
hold off
