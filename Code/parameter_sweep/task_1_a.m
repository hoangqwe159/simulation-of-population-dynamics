...
subplot(4,2,1)
plot(1:2001,y_s_50);
title("r = 2, h = 0.01, s = 50");

subplot(4,2,2)
plot(1:2001,y_s_100);
title("r = 2, h = 0.01, s = 100");

subplot(4,2,3)
plot(1:2001,y_s_150);
title("r = 2, h = 0.01, s = 150");

subplot(4,2,4)
plot(1:2001,y_s_200);
title("r = 2, h = 0.01, s = 200");

subplot(4,2,5)
plot(1:2001,y_s_250);
title("r = 2, h = 0.01, s = 250");

subplot(4,2,6)
plot(1:2001,y_s_300);
title("r = 2, h = 0.01, s = 300");

subplot(4,2,7)
plot(1:2001,y_s_350);
title("r = 2, h = 0.01, s = 350");
...
subplot(4,2,1)
plot(1:2001,y_s_50);
title("r = 0.5, h = 0.05, s = 50");

subplot(4,2,2)
plot(1:2001,y_s_100);
title("r = 0.5, h = 0.05, s = 100");

subplot(4,2,3)
plot(1:2001,y_s_150);
title("r = 0.5, h = 0.05, s = 150");

subplot(4,2,4)
plot(1:2001,y_s_200);
title("r = 0.5, h = 0.05, s = 200");

subplot(4,2,5)
plot(1:2001,y_s_250);
title("r = 0.5, h = 0.05, s = 250");

subplot(4,2,6)
plot(1:2001,y_s_300);
title("r = 0.5, h = 0.05, s = 300");

subplot(4,2,7)
plot(1:2001,y_s_350);
title("r = 0.5, h = 0.05, s = 350");

subplot(4,2,8)
plot(1:2001,y_s_400);
title("r = 0.5, h = 0.05, s = 400");